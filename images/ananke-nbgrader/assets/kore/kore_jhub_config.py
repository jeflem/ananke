...
async def nbgrader_post_auth(authenticator: LTI13Authenticator, handler: LTI13CallbackHandler, authentication: dict) -> bool:
    ...
    course_id, course_title, grader_user = make_course_id(lti_state=auth_state)
    ...
    # TODO may this be put inside the LTI file reader class?
    info_file_path = f'/home/{grader_user}/info.json'
    if is_instructor and not os.path.exists(info_file_path):
        ...
        try:
            ...
            os.system(f'chown -R {grader_user}:{grader_user} /home/{grader_user}/info.json')
            os.system(f'chmod -R go-rwx /home/{grader_user}/info.json')
