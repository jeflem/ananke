...
def get_course_list(autogenerated_file_path: str, subset: Subset = Subset.ALL) -> Response:
    ...
    Response
        ...
        The path of active courses have the following schema: `/home/GRADER_USER/course_data/`.
    """
...
def get_assignment_list(autogenerated_file_path: str) -> Response:
    """
    Generate a list of assignments based on user ownership.
    ...
    -------
    Response
        A Flask response object containing the assignment list or an error message.
    """
    ...
    active_assignment_paths = [
        ...
        for assignment_path in Path(f'{base_path}/course_data/source/').iterdir()
